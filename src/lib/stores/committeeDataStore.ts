...
const data = [
	{
		...
		description: `The Security Council of the United
Nations maintains international peace
...
global stability.`
	},
	{
		...
		description: `In today's world, many suffer as
fundamental human, social, and cultural
...
hope for a more equitable world.`
	},
	{
		...
		description: `DISEC addresses the global security
threats of LAWs and UAVs, balancing
...
humanitarian law.`
	...
	},
	{
		...
		agenda: 'Deliberation on reservation policy in India with special emphasis on the need for caste census',
		video: '/AIPPMVideo.mp4',
		image: '/CommitteePics/AIPPM.jpg',
		description: `In Bharat, the All-India Political
Parties Meet addresses critical issues.
