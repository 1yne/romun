...
>
	<div class="w-full flex justify-between text-white items-center bg-white/10 rounded-lg p-6 px-12">
	...
	<div class="w-full flex gap-8 justify-between">
		<div class="flex gap-8">
			<a href="https://www.instagram.com/romun_24/" target="_blank">
			...
			<a href="mailto:romuninfo@gmail.com" target="_blank">
